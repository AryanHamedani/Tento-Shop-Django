    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(error_messages={'unique': 'A user with that phone number already exists.'}, help_text='Required. Iranian Phone Number format.', max_length=128, region='IR', unique=True, verbose_name='Phone Number')),
